...
#make 3
producer = KafkaProducer(bootstrap_servers=['kafka:9092', 'kafka2:9091','kafka3:9090'],
                        #  api_version=(2, 1, 2),
                         api_version=(5, 1, 2),
...
def publisherfunction(json_data):
    ...
    app.logger.info("\publisherfunction")
    phen = json_data['PHEN']
